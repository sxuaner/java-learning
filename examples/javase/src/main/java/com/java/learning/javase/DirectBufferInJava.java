 ...
 * 
 * A byte buffer is either direct or non-direct. Given a direct byte buffer, the
 ...
 * allocate direct buffers only when they yield a measurable gain in program
 * performance.
 * 
 ...
 * 
 */
public class DirectBufferInJava {
